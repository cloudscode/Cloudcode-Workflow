...
public class ProcessDefinitionEntity extends ProcessDefinitionImpl implements
	...
	public ExecutionEntity createProcessInstance(String businessKey, String name,String formObject) {
		return createProcessInstance(businessKey, name,formObject, null);
	}

	public ExecutionEntity createProcessInstance(String businessKey,
			String name,String formObject, ActivityImpl initial) {
		...
		processInstance.setBusData(formObject);
	...
	public IdentityLinkEntity addIdentityLink(String userId, String groupId) {
		IdentityLinkEntity identityLinkEntity = IdentityLinkEntity
				.createAndInsert();
	...
	public void deleteIdentityLink(String userId, String groupId) {
		List<IdentityLinkEntity> identityLinks = Context
				...
				.findIdentityLinkByProcessDefinitionUserAndGroup(id, userId,
						groupId);
