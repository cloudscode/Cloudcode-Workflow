  ...
  <div class="form-group">
   ...
   <div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label">配置表单</label>
     ...
     <label for="inputEmail3" class="col-sm-2 control-label">数据权限</label>
	    <div class="col-sm-4">
	      <input type="text" name="dataManager" class="form-control" id="dataManager" placeholder="数据权限">
	    </div>
  </div>
  <div class="form-group">
